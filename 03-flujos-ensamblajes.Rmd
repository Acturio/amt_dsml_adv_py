...
_artist = ax.set_xlim(0, 1)
_artist = ax.set_title("Model Comparison")
```
...
_artist = ax.set_xlim(0, 1)
_artist = ax.set_title("Best Model Comparison")
```
...
ax = importance_df.sort_values("Importance").plot.barh(
...
ax = assembly_weights.sort_values("weight").plot.barh(x="model", y="weight", legend=False)
```
